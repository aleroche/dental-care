...
const SITE_NAME = "MiraMar Family Dental";
const ADDRESS = {
...
export function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-r from-[#0A6CFF] to-[#0052CC] text-white relative overflow-hidden">
      {/* Background Pattern */}
            ...
            <div className="flex gap-2">
              {SOCIAL.facebook && (
                <a 
                  ...
                  className="w-9 h-9 rounded-full bg-white/20 flex items-center justify-center hover:bg-[#00B894] transition-colors"
                >
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={item}>
                  <Link 
                    href="#"
                    className="text-white/80 hover:text-[#00B894] transition-colors text-sm flex items-center gap-2 group"
                  >
        ...
        <div className="border-t border-white/20 mt-12 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap gap-4 text-sm">
              ...
              <Link href="/hipaa" className="text-white/60 hover:text-white transition-colors">
                HIPAA
              </Link>
            ...
            <div className="flex items-center gap-2 text-sm">
              <button className="text-white/60 hover:text-white transition-colors">Español</button>
